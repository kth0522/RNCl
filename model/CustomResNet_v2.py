...
__all__ = ['ResNet', 'custom_resnet18', 'resnet34', 'resnet50', 'resnet101',
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        cat_tensor = torch.zeros([128, 64]).cuda()
...
def custom_resnet18_v2(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('custom_resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
